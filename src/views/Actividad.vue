  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9(data-aos="fade-left")
        .titulo-segundo
          h2 Organizando la información
        p.mb-4 Identificar los procedimientos archivísticos dentro de la empresa, buscando siempre la organización documental presente en los diferentes procesos. 
